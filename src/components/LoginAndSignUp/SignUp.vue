...
import PrivacyPolicyModal from '@/components/LoginAndSignUp/PrivacyPolicyModal.vue'
import TermsOfServiceModal from '@/components/LoginAndSignUp/TermsOfServiceModal.vue'
